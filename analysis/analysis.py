...
class MetaboliticsAnalysis:
    ...
    def set_objective(self, measured_metabolites):
        ...
        self.add_reactions_for_metabolites(measured_metabolites)
        for k, v in measured_metabolites.items():
            ...
            # TODO Update this producers to include consumers don't forget to skip the one that you added
            for r in m.reactions:
                if r.id.endswith('spill'):
                    continue
